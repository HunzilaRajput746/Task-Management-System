...
export const Modal = ({ isOpen, onClose, title, subtitle, children, maxWidth = 'max-w-2xl' }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
      ...
      {/* Modal Container */}
      <div
        className={`relative w-full ${maxWidth} bg-dark-surface border border-slate-700/70 rounded-2xl shadow-2xl z-10 my-8 overflow-hidden animate-slide-up flex flex-col max-h-[90vh]`}
      >
        {/* Header */}
